...
public class RebConversionApiTest {
    ...
    public void rebConversionConvertToExcelTest() throws Exception {
        ...
        File response = api.rebConversionConvertToExcel(rebFile, writePrices, writeLongTexts, conversionCulture);
    ...
    public void rebConversionConvertToGaebTest() throws Exception {
        ...
        File response = api.rebConversionConvertToGaeb(rebFile, destinationGaebType, targetExchangePhaseTransform, enforceStrictOfferPhaseLongTextOutput, exportQuantityDetermination, removeUnprintableCharactersFromTexts);
