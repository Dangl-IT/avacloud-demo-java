...
public class DanglIdentityApi {
    ...
    /**
     * Build call for danglIdentityGetUserInfo
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call danglIdentityGetUserInfoCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/identity/user-info";
    ...
    private com.squareup.okhttp.Call danglIdentityGetUserInfoValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = danglIdentityGetUserInfoCall(progressListener, progressRequestListener);
        return call;
     ...
     */
    public UserInfoGet danglIdentityGetUserInfo() throws ApiException {
        ApiResponse<UserInfoGet> resp = danglIdentityGetUserInfoWithHttpInfo();
        return resp.getData();
    }
     ...
     * 
     * 
     * @return ApiResponse&lt;UserInfoGet&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<UserInfoGet> danglIdentityGetUserInfoWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = danglIdentityGetUserInfoValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<UserInfoGet>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call danglIdentityGetUserInfoAsync(final ApiCallback<UserInfoGet> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = danglIdentityGetUserInfoValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<UserInfoGet>(){}.getType();
