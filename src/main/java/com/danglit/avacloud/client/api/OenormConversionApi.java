...
public class OenormConversionApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call oenormConversionConvertToExcelCall(File oenormFile, Boolean writePrices, Boolean writeLongTexts, String conversionCulture, Boolean includeArticleNumbers, Boolean lockAllCellsButPrices, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call oenormConversionConvertToExcelValidateBeforeCall(File oenormFile, Boolean writePrices, Boolean writeLongTexts, String conversionCulture, Boolean includeArticleNumbers, Boolean lockAllCellsButPrices, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = oenormConversionConvertToExcelCall(oenormFile, writePrices, writeLongTexts, conversionCulture, includeArticleNumbers, lockAllCellsButPrices, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public File oenormConversionConvertToExcel(File oenormFile, Boolean writePrices, Boolean writeLongTexts, String conversionCulture, Boolean includeArticleNumbers, Boolean lockAllCellsButPrices) throws ApiException {
        ApiResponse<File> resp = oenormConversionConvertToExcelWithHttpInfo(oenormFile, writePrices, writeLongTexts, conversionCulture, includeArticleNumbers, lockAllCellsButPrices);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<File> oenormConversionConvertToExcelWithHttpInfo(File oenormFile, Boolean writePrices, Boolean writeLongTexts, String conversionCulture, Boolean includeArticleNumbers, Boolean lockAllCellsButPrices) throws ApiException {
        com.squareup.okhttp.Call call = oenormConversionConvertToExcelValidateBeforeCall(oenormFile, writePrices, writeLongTexts, conversionCulture, includeArticleNumbers, lockAllCellsButPrices, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call oenormConversionConvertToExcelAsync(File oenormFile, Boolean writePrices, Boolean writeLongTexts, String conversionCulture, Boolean includeArticleNumbers, Boolean lockAllCellsButPrices, final ApiCallback<File> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = oenormConversionConvertToExcelValidateBeforeCall(oenormFile, writePrices, writeLongTexts, conversionCulture, includeArticleNumbers, lockAllCellsButPrices, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for oenormConversionConvertToFlatAva
     * @param oenormFile The input file (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call oenormConversionConvertToFlatAvaCall(File oenormFile, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/conversion/oenorm/flat-ava";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call oenormConversionConvertToFlatAvaValidateBeforeCall(File oenormFile, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = oenormConversionConvertToFlatAvaCall(oenormFile, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public FlatAvaProject oenormConversionConvertToFlatAva(File oenormFile) throws ApiException {
        ApiResponse<FlatAvaProject> resp = oenormConversionConvertToFlatAvaWithHttpInfo(oenormFile);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<FlatAvaProject> oenormConversionConvertToFlatAvaWithHttpInfo(File oenormFile) throws ApiException {
        com.squareup.okhttp.Call call = oenormConversionConvertToFlatAvaValidateBeforeCall(oenormFile, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call oenormConversionConvertToFlatAvaAsync(File oenormFile, final ApiCallback<FlatAvaProject> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = oenormConversionConvertToFlatAvaValidateBeforeCall(oenormFile, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<FlatAvaProject>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
