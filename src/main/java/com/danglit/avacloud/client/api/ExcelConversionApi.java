...
public class ExcelConversionApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call excelConversionConvertToExcelCall(File excelFile, Boolean readNewElements, Boolean rebuildItemNumberSchema, Boolean writePrices, Boolean writeLongTexts, String conversionCulture, Boolean includeArticleNumbers, Boolean lockAllCellsButPrices, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call excelConversionConvertToExcelValidateBeforeCall(File excelFile, Boolean readNewElements, Boolean rebuildItemNumberSchema, Boolean writePrices, Boolean writeLongTexts, String conversionCulture, Boolean includeArticleNumbers, Boolean lockAllCellsButPrices, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = excelConversionConvertToExcelCall(excelFile, readNewElements, rebuildItemNumberSchema, writePrices, writeLongTexts, conversionCulture, includeArticleNumbers, lockAllCellsButPrices, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public File excelConversionConvertToExcel(File excelFile, Boolean readNewElements, Boolean rebuildItemNumberSchema, Boolean writePrices, Boolean writeLongTexts, String conversionCulture, Boolean includeArticleNumbers, Boolean lockAllCellsButPrices) throws ApiException {
        ApiResponse<File> resp = excelConversionConvertToExcelWithHttpInfo(excelFile, readNewElements, rebuildItemNumberSchema, writePrices, writeLongTexts, conversionCulture, includeArticleNumbers, lockAllCellsButPrices);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<File> excelConversionConvertToExcelWithHttpInfo(File excelFile, Boolean readNewElements, Boolean rebuildItemNumberSchema, Boolean writePrices, Boolean writeLongTexts, String conversionCulture, Boolean includeArticleNumbers, Boolean lockAllCellsButPrices) throws ApiException {
        com.squareup.okhttp.Call call = excelConversionConvertToExcelValidateBeforeCall(excelFile, readNewElements, rebuildItemNumberSchema, writePrices, writeLongTexts, conversionCulture, includeArticleNumbers, lockAllCellsButPrices, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call excelConversionConvertToExcelAsync(File excelFile, Boolean readNewElements, Boolean rebuildItemNumberSchema, Boolean writePrices, Boolean writeLongTexts, String conversionCulture, Boolean includeArticleNumbers, Boolean lockAllCellsButPrices, final ApiCallback<File> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = excelConversionConvertToExcelValidateBeforeCall(excelFile, readNewElements, rebuildItemNumberSchema, writePrices, writeLongTexts, conversionCulture, includeArticleNumbers, lockAllCellsButPrices, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for excelConversionConvertToFlatAva
     * @param excelFile The input file (optional)
     * @param readNewElements Defaults to false (optional)
     * @param rebuildItemNumberSchema When importing new elements from Excel, sometimes the ItemNumberSchema in the file is not in compliance with the GAEB requirements. Enabling this option tries to repair the ItemNumberSchema. Defaults to false. (optional)
     * @param progressListener Progress listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call excelConversionConvertToFlatAvaCall(File excelFile, Boolean readNewElements, Boolean rebuildItemNumberSchema, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/conversion/excel/flat-ava";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call excelConversionConvertToFlatAvaValidateBeforeCall(File excelFile, Boolean readNewElements, Boolean rebuildItemNumberSchema, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = excelConversionConvertToFlatAvaCall(excelFile, readNewElements, rebuildItemNumberSchema, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public FlatAvaProject excelConversionConvertToFlatAva(File excelFile, Boolean readNewElements, Boolean rebuildItemNumberSchema) throws ApiException {
        ApiResponse<FlatAvaProject> resp = excelConversionConvertToFlatAvaWithHttpInfo(excelFile, readNewElements, rebuildItemNumberSchema);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<FlatAvaProject> excelConversionConvertToFlatAvaWithHttpInfo(File excelFile, Boolean readNewElements, Boolean rebuildItemNumberSchema) throws ApiException {
        com.squareup.okhttp.Call call = excelConversionConvertToFlatAvaValidateBeforeCall(excelFile, readNewElements, rebuildItemNumberSchema, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call excelConversionConvertToFlatAvaAsync(File excelFile, Boolean readNewElements, Boolean rebuildItemNumberSchema, final ApiCallback<FlatAvaProject> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = excelConversionConvertToFlatAvaValidateBeforeCall(excelFile, readNewElements, rebuildItemNumberSchema, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<FlatAvaProject>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
