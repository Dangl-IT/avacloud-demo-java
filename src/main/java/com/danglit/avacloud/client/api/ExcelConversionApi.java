...
public class ExcelConversionApi {
    ...
    public File excelConversionConvertToGaeb(File excelFile, Boolean readNewElements, Boolean rebuildItemNumberSchema, String destinationGaebType, String targetExchangePhaseTransform, Boolean enforceStrictOfferPhaseLongTextOutput, Boolean exportQuantityDetermination, Boolean removeUnprintableCharactersFromTexts) throws ApiException {
        ApiResponse<File> resp = excelConversionConvertToGaebWithHttpInfo(excelFile, readNewElements, rebuildItemNumberSchema, destinationGaebType, targetExchangePhaseTransform, enforceStrictOfferPhaseLongTextOutput, exportQuantityDetermination, removeUnprintableCharactersFromTexts);
        return resp.getData();
    }
    ...
    public ApiResponse<File> excelConversionConvertToGaebWithHttpInfo(File excelFile, Boolean readNewElements, Boolean rebuildItemNumberSchema, String destinationGaebType, String targetExchangePhaseTransform, Boolean enforceStrictOfferPhaseLongTextOutput, Boolean exportQuantityDetermination, Boolean removeUnprintableCharactersFromTexts) throws ApiException {
        com.squareup.okhttp.Call call = excelConversionConvertToGaebValidateBeforeCall(excelFile, readNewElements, rebuildItemNumberSchema, destinationGaebType, targetExchangePhaseTransform, enforceStrictOfferPhaseLongTextOutput, exportQuantityDetermination, removeUnprintableCharactersFromTexts, null, null);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
