...
public class XRechnungConversionApi {
     ...
     * @param avaWrapper  (required)
     * @param targetFormat The target format for the XRechnung export. Defaults to Ubl. Options are: Ubl, CrossIndustryInvoice and FacturX (ZUGFerd) (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call xRechnungConversionConvertAvaToXRechnungCall(AvaProjectWrapper avaWrapper, String targetFormat, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = avaWrapper;
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("TargetFormat", targetFormat));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call xRechnungConversionConvertAvaToXRechnungValidateBeforeCall(AvaProjectWrapper avaWrapper, String targetFormat, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = xRechnungConversionConvertAvaToXRechnungCall(avaWrapper, targetFormat, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public File xRechnungConversionConvertAvaToXRechnung(AvaProjectWrapper avaWrapper, String targetFormat) throws ApiException {
        ApiResponse<File> resp = xRechnungConversionConvertAvaToXRechnungWithHttpInfo(avaWrapper, targetFormat);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<File> xRechnungConversionConvertAvaToXRechnungWithHttpInfo(AvaProjectWrapper avaWrapper, String targetFormat) throws ApiException {
        com.squareup.okhttp.Call call = xRechnungConversionConvertAvaToXRechnungValidateBeforeCall(avaWrapper, targetFormat, null, null);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call xRechnungConversionConvertAvaToXRechnungAsync(AvaProjectWrapper avaWrapper, String targetFormat, final ApiCallback<File> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = xRechnungConversionConvertAvaToXRechnungValidateBeforeCall(avaWrapper, targetFormat, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call xRechnungConversionConvertInvoiceToXRechnungCall(Invoice invoice, String targetFormat, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = invoice;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call xRechnungConversionConvertInvoiceToXRechnungValidateBeforeCall(Invoice invoice, String targetFormat, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = xRechnungConversionConvertInvoiceToXRechnungCall(invoice, targetFormat, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public File xRechnungConversionConvertInvoiceToXRechnung(Invoice invoice, String targetFormat) throws ApiException {
        ApiResponse<File> resp = xRechnungConversionConvertInvoiceToXRechnungWithHttpInfo(invoice, targetFormat);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<File> xRechnungConversionConvertInvoiceToXRechnungWithHttpInfo(Invoice invoice, String targetFormat) throws ApiException {
        com.squareup.okhttp.Call call = xRechnungConversionConvertInvoiceToXRechnungValidateBeforeCall(invoice, targetFormat, null, null);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call xRechnungConversionConvertInvoiceToXRechnungAsync(Invoice invoice, String targetFormat, final ApiCallback<File> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = xRechnungConversionConvertInvoiceToXRechnungValidateBeforeCall(invoice, targetFormat, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
