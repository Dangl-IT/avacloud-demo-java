...
public class PriceInformationDto {
  ...
  @SerializedName("hasUnsetTaxRate")
  private Boolean hasUnsetTaxRate = null;
  ...
  **/
  ...
  public PriceInformationDto hasUnsetTaxRate(Boolean hasUnsetTaxRate) {
   ...
   * @return hasUnsetTaxRate
  **/
  @ApiModelProperty(required = true, value = "This property indicates if the TaxRate property is actually zero (0) or if it's just unset. The TaxRate is a non-nullable property, so it can't be null and therefore a distinction between unset and zero relies on this additional property. When exporting to GAEB, this can be used e.g. to decide whether or not the tax rate should be serialized. This property is automtically set to false when the TaxRate is set to any value, even zero. If the TaxRate is not set to zero, this property will always return false and can not be set to true.")
  public Boolean isHasUnsetTaxRate() {
    return hasUnsetTaxRate;
  }

  public void setHasUnsetTaxRate(Boolean hasUnsetTaxRate) {
    this.hasUnsetTaxRate = hasUnsetTaxRate;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, priceInformationDto.id) &&
        ...
        Objects.equals(this.hasUnsetTaxRate, priceInformationDto.hasUnsetTaxRate) &&
        Objects.equals(this.tradeDiscounts, priceInformationDto.tradeDiscounts);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, hourlyWage, deductionFactor, flatSum, taxRate, hasUnsetTaxRate, tradeDiscounts);
  }
  ...
  public String toString() {
    ...
    sb.append("    hasUnsetTaxRate: ").append(toIndentedString(hasUnsetTaxRate)).append("\n");
