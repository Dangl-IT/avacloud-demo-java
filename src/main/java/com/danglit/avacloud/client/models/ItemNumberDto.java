...
public class ItemNumberDto {
  ...
  @SerializedName("isAttachedToPosition")
  private Boolean isAttachedToPosition = null;
  ...
  **/
  @ApiModelProperty(value = "Will return this ItemNumber as point delimited string. Will not distinguish between upper- and lowercase and return an all-lowercase representation. Will consider first numbers, then characters, e.g. 1a is considered preceding aa. Transformation to all lowercase can be configured in the ItemNumberSchema property.")
  ...
  **/
  ...
  public ItemNumberDto hierarchyLevel(Integer hierarchyLevel) {
  ...
  **/
   ...
   * @return isAttachedToPosition
  **/
  @ApiModelProperty(required = true, value = "This property indicates if this ItemNumber is attached to an object of the Position type.")
  public Boolean isIsAttachedToPosition() {
    return isAttachedToPosition;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, itemNumberDto.id) &&
        ...
        Objects.equals(this.hierarchyLevel, itemNumberDto.hierarchyLevel) &&
        Objects.equals(this.isAttachedToPosition, itemNumberDto.isAttachedToPosition);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, stringRepresentation, isSchemaCompliant, itemNumberSchema, identifiers, isLot, hierarchyLevel, isAttachedToPosition);
  }
  ...
  public String toString() {
    ...
    sb.append("    isAttachedToPosition: ").append(toIndentedString(isAttachedToPosition)).append("\n");
    sb.append("}");
    return sb.toString();
  }
