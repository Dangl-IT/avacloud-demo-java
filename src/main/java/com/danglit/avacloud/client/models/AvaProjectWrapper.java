...
public class AvaProjectWrapper {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(project, invoiceNumber, documents, invoicePeriod, paymentInstructions, invoiceType, isEuReverseChargeInvoice, paymentDueDate, paymentTerms, previousInvoices, alreadyPaidTotalGross, references, allowances, charges, deliveryInformation);
  }
