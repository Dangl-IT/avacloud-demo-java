...
public class ItemNumberSchemaDto {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(totalLength, tiers, separator, filler, identifier, skipNonExistingLevelsInPositionItemNumbers, skippedTiersFiller, schemaIsCorrectlyDefined, allowUpperCaseLettering);
  }
