...
public class SubDescriptionDto {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, quantity, quantityComponents, amountToBeEnteredByBidder, identifier, shortText, longText, htmlLongText, additionType, standardizedDescription, executionDescriptionReference, projectCatalogues, descriptionId, hasBidderCommentInHtmlLongText);
  }
