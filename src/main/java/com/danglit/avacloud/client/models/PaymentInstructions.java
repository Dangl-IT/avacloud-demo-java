...
public class PaymentInstructions {
  ...
  **/
  ...
  public PaymentInstructions paymentTypeCode(String paymentTypeCode) {
   ...
   /**
   * This should be a code according to UN/ECE 4461 to identify the type of payment. For example, code \&quot;58\&quot; means SEPA Credit Transfer, and code \&quot;30\&quot; means non-SEPA Credit Transfer. See this list: https://unece.org/fileadmin/DAM/trade/edifact/code/4461cl.htm
   * @return paymentTypeCode
  **/
  @ApiModelProperty(value = "This should be a code according to UN/ECE 4461 to identify the type of payment. For example, code \"58\" means SEPA Credit Transfer, and code \"30\" means non-SEPA Credit Transfer. See this list: https://unece.org/fileadmin/DAM/trade/edifact/code/4461cl.htm")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, paymentTypeCode, paymentCreditorIdentifier, paymentMeans);
  }
