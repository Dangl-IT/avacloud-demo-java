...
public class ServiceSpecificationDto {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, projectHourlyWage, projectTaxRate, projectPriceComponents, projectItemNumberSchema, elements, projectLabourTimeLabel, containsDuplicateItemNumbers, ignoreDuplicateItemNumbers, totalPriceGrossByTaxRate, ignoreChildPriceUpdates, deductedPrice, deductionFactor, totalPrice, totalPriceGross, totalPriceGrossDeducted, type, bidder, gaebXmlId, exchangePhase, origin, creationDate, offerByDate, decisionDate, submissionLocation, description, name, priceInformation, projectCatalogues);
  }
