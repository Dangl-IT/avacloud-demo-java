...
public class ServiceSpecificationDto {
  ...
  **/
  ...
  public ServiceSpecificationDto origin(OriginDto origin) {
   ...
   /**
   * This indicates where the service specification originates, i.e. from an exchange file format or self created.
   * @return origin
  **/
  @ApiModelProperty(required = true, value = "This indicates where the service specification originates, i.e. from an exchange file format or self created.")
   ...
   * @return creationDate
  **/
  @ApiModelProperty(required = true, value = "Creation date of this ServiceSpecification.")
   ...
   * @return offerByDate
  **/
  @ApiModelProperty(required = true, value = "Date indicating until when an offer has to be submitted. In German, this is often called the \"Eröffnungstermin\"")
   ...
   * @return decisionDate
  **/
  @ApiModelProperty(required = true, value = "Date indicating by when the buyer will select a contractor.")
  ...
  **/
  @ApiModelProperty(value = "These are Catalogues that are used within this ServiceSpecification. Catalogues are used to describe catalogues, or collections, that can be used to describe elements with commonly known properties. For example, QuantityAssignments use these to categorize themselves. They are propagate to all child elements, e.g. other containers and QuantityAssignments.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The date when the execution of the services is scheduled to start")
  ...
  **/
  @ApiModelProperty(required = true, value = "The date then the execution of the services is scheduled to be finished")
   ...
   * @return contractDate
  **/
  @ApiModelProperty(required = true, value = "The date on which the contract has been awarded. This matches \"Auftragsdatum\" in GAEB")
  ...
  **/
   ...
   * @return warrantyEnd
  **/
  @ApiModelProperty(required = true, value = "The date on which the warranty period ends")
   ...
   * @return approvalDate
  **/
  @ApiModelProperty(required = true, value = "The date on which the services rendered by the bidder are scheduled to be approved by the buyer")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, projectHourlyWage, projectTaxRate, projectPriceComponents, projectItemNumberSchema, elements, projectLabourTimeLabel, containsDuplicateItemNumbers, ignoreDuplicateItemNumbers, totalPriceGrossByTaxRate, ignoreChildPriceUpdates, deductedPrice, deductionFactor, totalPrice, totalPriceGross, totalPriceGrossDeducted, priceType, bidder, bidderDiscriminator, gaebXmlId, projectInformation, exchangePhase, origin, creationDate, offerByDate, decisionDate, submissionLocation, description, name, priceInformation, projectCatalogues, plannedExecutionStart, plannedExecutionEnd, contractDate, contractIdentifier, warrantyDuration, warrantyEnd, approvalDate, typeOfApproval);
  }
