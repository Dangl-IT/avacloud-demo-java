...
public class ServiceSpecificationDto {
  ...
  private Object projectInformation = null;
  ...
  **/
  ...
  public ServiceSpecificationDto projectInformation(Object projectInformation) {
  ...
  **/
  @ApiModelProperty(value = "")
  public Object getProjectInformation() {
    return projectInformation;
  }

  public void setProjectInformation(Object projectInformation) {
    this.projectInformation = projectInformation;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, projectHourlyWage, projectTaxRate, projectPriceComponents, projectItemNumberSchema, elements, projectLabourTimeLabel, containsDuplicateItemNumbers, ignoreDuplicateItemNumbers, totalPriceGrossByTaxRate, ignoreChildPriceUpdates, deductedPrice, deductionFactor, totalPrice, totalPriceGross, totalPriceGrossDeducted, priceType, bidder, gaebXmlId, projectInformation, exchangePhase, origin, creationDate, offerByDate, decisionDate, submissionLocation, description, name, priceInformation, projectCatalogues);
  }
